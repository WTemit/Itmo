...
public class AddIfMax extends Command {
    public AddIfMax(ClientNetworkIO networkIO, StandardConsole console, UserManager userManager) {
        super("add_if_max", "добавить новый элемент, если он превышает максимальный", networkIO, console, userManager);
    }
    ...
    public ExecutionResponse apply(String[] arguments) {
        ...
        try {
            console.println("* Creating a new Worker for comparison:");
